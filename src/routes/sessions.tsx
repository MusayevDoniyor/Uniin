  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <section className="mb-6">
        <h2 className="font-semibold mb-2 text-sm uppercase tracking-wide text-muted-foreground">Upcoming</h2>
        {upcoming.length === 0 && <div className="surface-card p-6 text-sm text-muted-foreground text-center">No upcoming sessions.</div>}
        <div className="space-y-2">{upcoming.map(s => <SessionCard key={s.id} s={s} />)}</div>
      </section>

      <section>
        <h2 className="font-semibold mb-2 text-sm uppercase tracking-wide text-muted-foreground">Past</h2>
